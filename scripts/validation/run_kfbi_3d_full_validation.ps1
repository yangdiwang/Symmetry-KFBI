...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File `
  scripts/validation/run_kfbi_3d_full_validation.ps1 -DryRun
...
.EXAMPLE
powershell.exe -NoProfile -ExecutionPolicy Bypass -File `
  scripts/validation/run_kfbi_3d_full_validation.ps1 -RunLabel full_20260819 `
