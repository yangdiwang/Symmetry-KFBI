...
{
    const auto range = edge_parameter_range(patch, edge);
    NurbsPatchEdge3D public_edge = NurbsPatchEdge3D::UMin;
    switch (edge) {
    case PatchEdge::UMin: public_edge = NurbsPatchEdge3D::UMin; break;
    case PatchEdge::UMax: public_edge = NurbsPatchEdge3D::UMax; break;
    case PatchEdge::VMin: public_edge = NurbsPatchEdge3D::VMin; break;
    case PatchEdge::VMax: public_edge = NurbsPatchEdge3D::VMax; break;
    }
    return estimate_nurbs_patch_edge_interval_length_3d(
        patch, public_edge, range.first, range.second, num_samples);
}
