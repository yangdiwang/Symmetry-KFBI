#include <src/support/cauchy/harmonic_cauchy_fit_3d.hpp>

#define main neumann_exterior_zero_trace_3d_application_main
#include "apps/laplace/3d/neumann_exterior_zero_trace_3d.cpp"
#undef main
...
void test_failed_coarse_requires_na_adjacent_order()
{
    ...
    const auto script = std::filesystem::current_path()
        / "scripts/validation/audit_neumann_two_level_edge_cauchy_3d.ps1";
